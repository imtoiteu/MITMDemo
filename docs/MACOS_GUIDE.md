# MITMDemo - macOS Setup & Demo Guide
...
> - Install packet capture support
...
>
> The launcher script automatically creates and uses `.venv`.
...
This is the macOS loopback interface used for localhost traffic.
